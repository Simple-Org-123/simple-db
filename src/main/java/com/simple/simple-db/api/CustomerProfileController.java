package com.simple.simple-db.api;

import java.net.URI;
import java.util.List;
import java.util.stream.Collectors;

import com.simple.simple-db.domain.CustomerProfileChangeRequest;
import com.simple.simple-db.domain.CustomerProfileCreateRequest;
import com.simple.simple-db.domain.CustomerProfileResponse;
import com.simple.simple-db.domain.CustomerProfileService;
